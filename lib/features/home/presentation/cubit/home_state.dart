...
class HomeState with _$HomeState {
  const factory HomeState({
    ...
    @Default(null) List<Group>? activeGroups,
    @Default(null) List<Group>? unActiveGroups,
    @Default(null) Group? group,
    @Default(null) GroupsCommonResponse? commonResponse,
    @Default(null) GroupsCommonResponse? activeStatusCommonResponse,
    @Default(null) GroupsCommonResponse? unActiveStatusCommonResponse,
